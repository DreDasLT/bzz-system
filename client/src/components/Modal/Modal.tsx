...
const Modal = ({ open, children, onClose }) => {
  ...
  return modalDiv ? ReactDom.createPortal(
    <>
      <div
      ...
      >
        <div className='p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24'>
          <div onClick={onClose} className='shadow absolute right-0 top-0 w-10 h-10 rounded-full bg-white text-gray-500 hover:text-gray-800 inline-flex items-center justify-center cursor-pointer'>
            <svg
